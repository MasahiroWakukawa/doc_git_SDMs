...
#```{r echo=FALSE, results='hold'} ###this is for RMarkdown
library(knitr)
kable(read.table(file = paste("../figs/","Stacked_analysis/AllContinents_Evaluation",sep="")))



### Create maps showing the difference of species richness (present vs RCP8.5) in Australia
...
### Create maps showing the difference of species richness (present vs RCP8.5) in Africa
...
### Create maps showing the difference of species richness (present vs RCP8.5) in Asia
...
### Create maps showing the difference of species richness (present vs RCP8.5) in Europe
...
### Create maps showing the difference of species richness (present vs RCP8.5) in South America
...
### Create maps showing the difference of species richness (present vs RCP8.5) in North America
